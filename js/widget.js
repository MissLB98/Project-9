...
recentActivity.onreadystatechange = () => {
...
//    document.getElementById('recent-activity').innerHTML = activityHTML;
    ...
    document.getElementById('recentActivity').innerHTML = recentActivity.responseText;
    
  }
};
//recentActivity.open("GET", "../data/recent-activity.json");
recentActivity.open("GET", "../js/activity.html");
recentActivity.send();

// I'm commenting out the json file approach to figure it out later. Fpr now, I'll just load HTML.